$(document).ready(function() {
   ...
   var characters = {
    'Ice Cube': {
      ...
      health: 120,
      attack: 8,
      imageUrl: "assets/images/icecube.jpg",
      enemyAttackBack: 15
    },
     'Jay-Z': {
      name: 'Jay-Z',
       health: 100,
       attack: 14,
       imageUrl: "assets/images/jayz.jpg",
       enemyAttackBack: 5
     },
     'Kanye West': {
       name: 'Kanye West',
       health: 150,
       attack: 8,
       imageUrl: "assets/images/kanyewest.jpg",
       enemyAttackBack: 20
     },
     'Pimp C': {
       name: 'Pimp C',
       health: 180,
       attack: 7,
       imageUrl: "assets/images/pimpc.jpg",
       enemyAttackBack: 25
     }
   };
  ...
  // Create function to render to DOM
   ...
   var renderCharacters = function(charObj, areaRender) {
     ...
     //rerender defender when attacked
